...
<style>
  ...
  <body class="goto-here" data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light scrolled awake" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="{{url('/')}}">E Tribe</a>
				...
				<div class="row">
							...
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex fadeInUp ftco-animated" style="background-image: url( {{asset('client/images/55.jpg')}} );">
									<div class="text text-center">
										...
										<p><a href="{{url('login')}}" class="btn btn-primary">Shop now</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"  style="background-image: url({{asset('client/images/69.jpg')}});">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="{{url('guest_handcrafts')}}">Handcrafts</a></h2>
									</div>
								</div>
								<div  class="category-wrap ftco-animate img d-flex align-items-end fadeInUp ftco-animated" style="background-image: url({{asset('client/images/44.jpg')}});">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="{{url('guest_wall_paint')}}">Wall Paintings</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end fadeInUp ftco-animated" style="background-image: url( {{asset('client/images/img17.jpg')}} );">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="{{url('guest_forest_product')}}">Minor Forest Products</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end fadeInUp ftco-animated" style="background-image: url( {{asset('client/images/53.jpg')}} );">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="{{url('guest_arts')}}">Arts</a></h2>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
			...
			@for($i=0;$i<count($data);$i++)
					<div class="col-lg-3 ftco-animate fadeInUp ftco-animated">
						<div class="product">
							<a href="{{asset('productcategoryimages/'.$data[$i]->category_name.'/'.$data[$i]->supplier_id.'/'.$data[$i]->image )}}" class="img-prod">
								<img class="img-fluid" src="{{asset('productcategoryimages/'.$data[$i]->category_name.'/'.$data[$i]->supplier_id.'/'.$data[$i]->image )}}" style="height: 200px;width:300px;" >
							</a>
							<div class="text py-3 pb-4 px-3 text-center">
								<h3> {{$data[$i]->product_name}} </h3>
								<p class="price"><span class="price-sale">₹{{$data[$i]->price}} </span></p>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate fadeInUp ftco-animated">
            ...
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
            <h3><a href="{{url('/login')}}">Golden Nandi</a></h3>
            <span class="price">now ₹ 80000 only</span>
    ...
    <footer class="ftco-footer ftco-section" >
      <div class="container" id="gotofooter">
      	<div class="row">
      		<div class="mouse">
						<a href="{{url('login')}}" class="mouse-icon">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Let Tribal Community Be More Expressive</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="{{url('/')}}" class="py-2 d-block">Shop</a></li>
                <li><a href="#gotoabout" class="py-2 d-block">About</a></li>
                <li><a href="{{url('/')}}" class="py-2 d-block">Journal</a></li>
                <li><a href="#gotofooter" class="py-2 d-block">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="d-flex">
	              <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
	                <li><a href="{{url('/')}}" class="py-2 d-block">Shipping Information</a></li>
	                <li><a href="{{url('/')}}" class="py-2 d-block">Returns &amp; Exchange</a></li>
	                <li><a href="{{url('/')}}" class="py-2 d-block">Terms &amp; Conditions</a></li>
	                <li><a href="{{url('/')}}" class="py-2 d-block">Privacy Policy</a></li>
	              </ul>
	              <ul class="list-unstyled">
	                <li><a href="{{url('/')}}" class="py-2 d-block">FAQs</a></li>
	                <li><a href="{{url('/')}}" class="py-2 d-block">Contact</a></li>
	              </ul>
	            </div>
            </div>
          </div>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="{{url('/')}}"><span class="icon icon-phone"></span><span class="text">+91 9999988888</span></a></li>
	                <li><a href="{{url('/')}}"><span class="icon icon-envelope"></span><span class="text">etribewebsite@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
