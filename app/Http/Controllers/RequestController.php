...
class RequestController extends Controller
{
    ...
    public function show($request_id)
    {
      ...
      if( session()->exists('admin_id') ){
          ...
          if(file_exists('productcategoryimages')){
            ...
            mkdir("productcategoryimages/Handcrafts");
            mkdir("productcategoryimages/Arts");
            mkdir("productcategoryimages/Paintings");
            mkdir("productcategoryimages/Forest Products");
    ...
    public function destroy($d)
    {
      ...
      {
        #echo $d,"<br>";
        # get image name for deleting requested image
        $img_name = DB::select("select product_image from tbl_requests where request_id=?",[$d]);
        #echo $img_name[0]->product_image;
        #exit();
        unlink("requestedImages/".$img_name[0]->product_image);
